...
if __name__ == "__main__":
    os.chdir('/Users/jokuo/Desktop/ECE143 Final Project/Voting Election 2020 Table')
    ...
    plt.pie(df_all_ages_eduction_level_Voted.Number.values, labels = ['less_than_9th_grade','9th_to_12th_grade','high_school_graduate','some_college_or_associate_deg','bachelor_deg','advanced_deg'],autopct = '%1.1f%%',textprops={'fontsize': 25}) 
